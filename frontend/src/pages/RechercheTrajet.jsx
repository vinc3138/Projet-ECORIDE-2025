...
export default function RechercheTrajets() {
  ...
  useEffect(() => {
	...
	const fetchTrajets = (params) => {
	  ...
	  fetch(`${API_URL}/api/recherche-trajet?${query}`)
		.then(res => res.json())
		.then(data => {
					  ...
					  <div className="row g-3 align-items-center">
						...
						<div className="col-md-4 d-flex justify-content-center align-items-center">
						  ...
						  >
							<img
							  src={
								trajet.chauffeur?.photo?.startsWith('data:image/')
						...
						{/* Colonne info + bouton */}
						<div className="col-md-8 fs-6 fs-md-5 fs-lg-4">
						  <div className="fw-bold text-success mb-3 titre-trajet">
						  ...
						  <div className="row h-100">
							...
							<div className="container-fluid px-0">
							  ...
							  <div className="row mb-2">
								<div className="col-lg12 col-lg-6 texte-trajet">
								  📅 <strong>Date de départ :</strong> {trajet.dateDepart}
								</div>
								<div className="col-lg12 col-lg-6 texte-trajet">
							  ...
							  {/* Ligne prix + chauffeur */}
							  <div className="row mb-2">
								<div className="col-lg12 col-lg-6 texte-trajet">
								  💲 <strong>Prix :</strong> {trajet.prix} crédits
								</div>
								<div className="col-lg12 col-lg-6 texte-trajet">
								  👤 <strong>Chauffeur :</strong> {trajet.chauffeur?.pseudo ?? 'N/A'}
								</div>
							  </div>
							  ...
							  <div className="row mb-2">
								<div className="col-lg12 col-lg-6 texte-trajet">
								  ⌚ <strong>Durée :</strong> {trajet.duree}
								</div>
								<div className="col-lg12 col-lg-6 texte-trajet">
								  📍 <strong>Distance :</strong> {trajet.distance} km
								</div>
							  </div>

							  {/* Ligne distance + voiture */}
							  <div className="row mb-2">
								<div className="col-lg12 col-lg-6 texte-trajet">
								  📝 <strong>Note :</strong> {trajet.chauffeur?.note ?? 'N/A'} ⭐
								</div>
								<div className="col-12 col-lg-6 texte-trajet">
								  🚗 <strong>Voiture :</strong> {trajet.voiture?.modele ?? 'N/A'}
								</div>
							  </div>
							  ...
							  <div className="row mb-3">
								<div className="col-lg12 col-lg-6 texte-trajet">
								  💺 <strong>Places disponibles :</strong> {trajet.place}
								</div>
							  </div>
							</div>
