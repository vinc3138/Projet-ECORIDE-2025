...
export default function CompteEmploye() {
  ...
  const fetchAvisNegatifs = async () => {
    try {
      const response = await fetch('https://127.0.0.1:8000/api/avis_negatifs', {
        method: 'GET',
        headers: {
  ...
  const fetchAvisAValider = async () => {
    try {
      const response = await fetch('https://127.0.0.1:8000/api/avis_a_valider', {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const updateAvisStatus = async (avisId, status) => {
    ...
    try {
      const response = await fetch('https://127.0.0.1:8000/api/validation_avis', {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
